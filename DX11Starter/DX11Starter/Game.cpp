...
void Game::CreateBasicGeometry()
{
	...
	CreateWICTextureFromFile(device, context, L"assets\\pasta.jpg", nullptr, &textureView);
...
void Game::Update(float deltaTime, float totalTime)
{
	...
	if (GetAsyncKeyState(VK_ESCAPE))
		Quit();
	//entities[0]->Move(XMFLOAT3(1 * deltaTime, 0, 0));
	//entities[1]->Move(XMFLOAT3(1 * deltaTime, 0, 0));
	//entities[2]->Move(XMFLOAT3(1 * deltaTime, 0, 0));
